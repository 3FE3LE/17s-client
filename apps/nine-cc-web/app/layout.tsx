...
export const metadata: Metadata = {
  ...
  description:
    'Nine Care Companion: cuidado compartido para quien mas quieres. Care Circle, medicamentos, citas y notas en una sola plataforma.',
  icons: {
    icon: [
...
export default async function RootLayout({ children }: { children: ReactNode }) {
  ...
  const productLinks = [
    ...
    { label: 'Linea diaria', href: '/patients' },
  ];
        ...
        <WebAuthProvider>
          <AppProviders>
            ...
            <AppProductFooter
              ...
              productTagline="Cuidado compartido para quien mas quieres."
              suiteName="17Suit"
              actionControls={
                <>
                  <Link
